...
const roundedToTwoNumbers = exercise4.toFixed(2);

console.log(roundedToTwoNumbers);
...
const capitalizeFixed = fact.replace("javascript", "Javascript")

console.log(capitalizeFixed);
